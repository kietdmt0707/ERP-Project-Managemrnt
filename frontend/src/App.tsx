...
import { authService, AuthResponse, UserRole } from './services/api';
...
function App() {
  ...
  // Tab selections
  const [activeTab, setActiveTab] = useState<'gantt' | 'ricefw' | 'approvals' | 'costs' | 'environments'>('gantt');
      ...
      <div className="min-h-screen flex items-center justify-center bg-dark-950 px-4 relative overflow-hidden">
        ...
        <div className="w-full max-w-md space-y-8 glass-panel p-8 rounded-3xl border border-dark-800 shadow-2xl relative z-10 animate-slide-up">
          <div className="text-center">
            ...
            <h1 className="mt-4 text-2xl font-bold tracking-tight text-white">ARON ERP-PM</h1>
            <p className="mt-2 text-xs text-dark-400">Hệ thống quản lý triển khai giải pháp Oracle ERP</p>
          </div>
    ...
    <div className="min-h-screen bg-dark-950 flex flex-col">
      ...
      <header className="border-b border-dark-850 bg-dark-900/60 backdrop-blur-md sticky top-0 z-30 px-6 py-4 flex justify-between items-center">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-md font-bold text-white tracking-wide">ARON ERP-PM</h1>
