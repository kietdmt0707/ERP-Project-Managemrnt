...
export const ProjectManager: React.FC<ProjectManagerProps> = ({ onProjectCreated }) => {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {projects.map((project) => (
            <div key={project.projectId} className="glass-panel p-5 rounded-2xl border border-dark-800 space-y-4 hover:border-dark-700 transition-all flex flex-col justify-between">
              ...
              <div className="pt-4 border-t border-dark-850 flex items-center justify-between text-[10px] text-dark-500">
                <span>Trạng thái: 
